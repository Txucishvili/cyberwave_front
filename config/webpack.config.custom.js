...
const reactCFG = require("react-scripts/config/webpack.config")('development');
...
module.exports = (env) => {
  ...
  var moduleFiles = {
    appInit: ["./src/modules/index.ts"],
    loaders: ["./src/modules/loaders.ts"],
    extras: ["./src/modules/extras.ts"],
  }
  var devDep = [];
  ...
  var appFiles = Object.assign({}, {
    ...
    name: "app",
    entry: {
      appInit: [].concat(moduleFiles.appInit),
      loaders: [].concat(moduleFiles.loaders),
      extras: [].concat(moduleFiles.extras),
      app: devDep.concat(sassFiles, jsFiles),
    },
    target: "web",
    devtool: isEnvDevelopment && "cheap-module-source-map",
    output: {
      path: env == "production" ? path.resolve(__dirname, OUTPUT_DIR) : undefined,
      ...
      filename: env === "production" ?
        "[name].[contenthash:5].js" : `[name]-[hash].${appConfig.APP_VERSION.slice(0, 1)}.bundle.js`,
